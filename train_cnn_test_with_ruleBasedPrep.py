...
conda install pydantic==1.9
python -m pip install tetris-gymnasium
...
from Heuristic_rulebased_model import *
...
def make_env(env_id, seed, idx, capture_video, run_name):
    def thunk():
        ...
        env = gym.wrappers.ResizeObservation(env, (84, 84),hi=7)
        env = gym.wrappers.GrayscaleObservation(env,hi=7)
